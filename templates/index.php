        ...
        <?php foreach ($lotList as $lot): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= htmlspecialchars($lot['imgUrl']) ?>" width="350" height="260" alt="<?= htmlspecialchars($lot['name']) ?>">
                </div>
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?= formatPrice(htmlspecialchars($lot['price'])) ?><b class="rub">р</b></span>
                        </div>
